...
from ev3dev2.motor import  LargeMotor, MoveSteering, MediumMotor, OUTPUT_B, OUTPUT_C, OUTPUT_D
...
def MediumMotors(whichMotor,numberOfRotations, speed): # cant have the same name as import (MediumMotor)
    #===========================================================================
    '''if whichMotor == "Left":
